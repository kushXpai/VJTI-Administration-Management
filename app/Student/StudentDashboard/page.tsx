...
import NoticeContent from "../Sidebar/Notice/page";
        ...
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-red-900 font-bold text-lg hidden sm:block">
                VJTI Hostel Portal
              </h1>
            </div>
          </div>
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    ...
                    className={`flex items-center px-4 py-3 rounded-xl w-full text-left ${
