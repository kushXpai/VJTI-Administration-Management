...
//     setConfirming(true);
//     console.log('Swapping:', { student1Id: student1.id, student2Id: student2.id });
...
//             onClick={handleSwap}
//             disabled={swapLoading || confirming}
//             className="flex-1 px-4 py-2 bg-[#10B981] text-white rounded-md hover:bg-[#0D9F72] disabled:bg-gray-400"
//           >
//             {swapLoading || confirming ? 'Swapping...' : 'Confirm Swap'}
//           </button>
//           <button
