        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-3xl font-bold text-gray-800 mb-1">B-204</p>
                    <p className="text-sm text-gray-500">Double Sharing • Block B • 2nd Floor</p>
                </div>
                ...
                <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-100">
                        <div className="p-5 hover:bg-gray-50">
                            ...
                            <p className="text-sm text-gray-600">New menu for the month of April is now available. Check the Mess Management section for details.</p>
                        </div>
                        <div className="p-5 hover:bg-gray-50">
                            <div className="flex justify-between mb-1">
                        ...
                        <div className="p-5 hover:bg-gray-50">
                            ...
                            <p className="text-sm text-gray-600">Block B water tanks will be cleaned on April 10th. Water supply will be interrupted from 10 AM to 2 PM.</p>
                        </div>
                    </div>
