      ...
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md p-6">
          ...
          <div>
            ...
            {messName && (
              <p className="text-lg text-gray-600">
                Mess Name: <span className="font-semibold text-gray-800">{messName}</span>
              </p>
            )}
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="text-red-600 text-center">
            {error}
            <button
              className="mt-3 px-4 py-2 bg-[#800000] text-white rounded hover:bg-[#5a0000] transition"
              onClick={() => user && fetchMenuData(user.id)}
            >
              Retry
            </button>
          </div>
