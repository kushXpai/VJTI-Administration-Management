...
import { useRevenueData } from "./hooks/useRevenueData";
import CollapsibleSection from "./components/CollapsibleSection"; // Correct import name
import RevenueTable from "./components/RevenueTable";
import RevenueSummaryTable from "./components/RevenueSummaryTable";
import Header from "@/app/Components/Header";
import Footer from "@/app/Components/Footer";
      ...
      <div className="flex-1 flex flex-row">
        <main className="flex-1 p-8">
          ...
          <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-200 shadow-sm flex items-center justify-center py-2 px-4 gap-4 md:gap-8 mb-6">
            <a
              href="#mess1-section"
              className="px-3 py-1 rounded-lg font-semibold text-gray-900 hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              Mess 1
            </a>
            <a
          ...
          {notification && (
            <div
              className={`mb-4 p-3 rounded-lg shadow text-center font-semibold transition-all duration-300 ${
                notification.type === "success"
                  ? "bg-green-100 text-green-800 border border-green-300"
                  : "bg-red-100 text-red-800 border border-red-300"
              }`}
          ...
          <div className="flex flex-col gap-8 mt-6">
            <div id="mess1-section">
              ...
              >
                <RevenueTable
                  revenueData={getRevenueByMessBlock("C Block")}
                  loading={loading}
            ...
            <div id="mess2-section">
              ...
              >
                <RevenueTable
                  revenueData={getRevenueByMessBlock("D Block")}
                  loading={loading}
                  handleViewReceipt={handleViewReceipt}
                />
              </CollapsibleSection>
            ...
            <div id="mess3-section">
              ...
              >
                <RevenueTable
                  revenueData={getRevenueByMessBlock("E Block")}
                  loading={loading}
                  handleViewReceipt={handleViewReceipt}
                />
              </CollapsibleSection>
